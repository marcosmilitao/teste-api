package com.sorteonline.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.sorteonline.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.sorteonline.repository.UserRepository.USERS_BY_EMAIL_CACHE);
